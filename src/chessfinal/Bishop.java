 ...
 * @author soheil
 */
public class Bishop extends Glaze {
     ...
     * @param g
     */
    public Bishop(int index, Cord c, Group root, Game g) {
        super(index, c, root, g);
        Image image;
        if (super.getWB() > 0) {
            image = new Image(getClass().getResourceAsStream("BishopB.png"));
        } else {
            image = new Image(getClass().getResourceAsStream("BishopW.png"));
        }
