 ...
 * @author soheil
 */
public class Rook extends Glaze {
     ...
     * @param g
     */
    public Rook(int index, Cord c, Group root, Game g) {
        super(index, c, root, g);
            Image image;
            if (super.getWB() > 0) {
                image = new Image(getClass().getResourceAsStream("RookB.png"));
            } else {
                image = new Image(getClass().getResourceAsStream("RookW.png"));
            }
